...
class AppColors {
  static const primary = Color(0xFFE53935);      // GymGeek red
...
class AppConstants {
  ...
  // Ollama config — change IP for physical device testing
  // Use 10.0.2.2 for Android emulator, your machine's LAN IP for real device
  static const String ollamaBaseUrl = 'http://10.0.2.2:11434';
  static const String ollamaModel = 'llama3';

  // No-detection timeout
  static const int noDetectionTimeoutSeconds = 15;
}
